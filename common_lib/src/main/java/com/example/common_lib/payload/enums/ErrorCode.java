...
public enum ErrorCode {
    ...
    ALBUM_ALREADY_EXIST("ALBUM_ALREADY_EXIST", "Album already exists", HttpStatus.BAD_REQUEST),
    ALBUM_NOT_FOUND("ALBUM_NOT_FOUND", "Album not found", HttpStatus.NOT_FOUND),
    SONG_NOT_FOUND("SONG_NOT_FOUND", "Song not found", HttpStatus.NOT_FOUND),
    PLAYLIST_NOT_FOUND("PLAYLIST_NOT_FOUND", "Playlist not found", HttpStatus.NOT_FOUND),
    SONG_ALREADY_EXIST("SONG_ALREADY_EXIST", "Song already exists", HttpStatus.BAD_REQUEST),
    PLAYLIST_ALREADY_EXIST("PLAYLIST_ALREADY_EXIST", "Playlist already exists", HttpStatus.BAD_REQUEST),
